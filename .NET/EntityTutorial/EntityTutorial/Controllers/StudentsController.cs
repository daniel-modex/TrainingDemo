...
namespace EntityTutorial.Controllers
{
    public class StudentsController : Controller
    {
        ...
        {
            var studentDBContext = _context.Students.Include(s => s.Grade);
        ...
        public async Task<IActionResult> Create([Bind("FirstName,LastName,GradeId")] AddStudent addstudent)
        {
            var student = new Student()
            {
                FirstName = addstudent.FirstName,
                LastName = addstudent.LastName,
                GradeId = addstudent.GradeId,
            };
            ...
            ViewData["GradeId"] = new SelectList(_context.Grades, "GradeId", "GradeName", student.GradeId);
            return View(student);
        }
